...
for lat, lon in zip(filtered_latitudes, filtered_longitudes):
    ...
    for time1 in unique_time:
        ...
        celcius_at_500 = temperature_at_500 - 273.15
        celcius_at_850 = temperature_at_850 - 273.15
        
        temperature_diffrence = (celcius_at_850 - celcius_at_500).round(decimals= 5)# I
        temp_diff = temperature_at_500 - temperature_at_850
...
plt.title(f'Temperature Difference (500mb - 850mb)')
plt.legend()
plt.show()