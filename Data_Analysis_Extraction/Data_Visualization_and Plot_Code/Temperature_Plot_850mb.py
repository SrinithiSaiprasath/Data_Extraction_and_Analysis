...
buoy_data = {'AD06': {'lat': 18.31, 'lon': 67.33}}
...
for lat, lon in zip(filtered_latitudes, filtered_longitudes):
    ...
    for time1 in unique_time:
        ...
        celcius_at_850 = int(temperature_at_850 - 273.15)
        temperature_diff.append(temperature_at_850)
        times.append(time1)
...
plt.title(f'Temperature At 850mb')
plt.legend()
plt.show()